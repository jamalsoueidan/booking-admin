...
<Meta title="Providers/SettingsProvider" />
...
If this Provider is not a wrapper for the entire application, then you will not be able to use the components that are provided in frontend ui.
